...
const banners = [
  ...
  { id: 2, emoji: '🆓', title: 'Free Delivery', subtitle: 'On orders above ₹199', bg: 'bg-secondary/20' },
    ...
    <div className="flex gap-3 overflow-x-auto no-scrollbar px-1 py-1">
      {banners.map((b, i) => (
        <motion.div
          ...
          className={`${b.bg} rounded-2xl p-4 min-w-[260px] flex items-center gap-3 shrink-0`}
        >
